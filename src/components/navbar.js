...
export default function Navbar() {
    ...
    return (
        <div className="flex flex-row justify-between px-10 border-b-2 border-gray-2 py-2 items-center">
            <div className="flex flex-row items-center"><Link className="text-2xl font-bold pr-10" to="/">DE</Link> <Link to="/">Home</Link></div>
