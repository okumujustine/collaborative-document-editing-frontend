        ...
        <div className="lg:w-6/12 w-11/12 mx-auto mt-6">
            <div>
                ...
                {!loading && myDocuments.length === 0 && <div className="flex flex-col justify-center items-center lg:mt-20">
                    <h2 className="text-2xl text-gray-500">No documents yet?, create one.{!user && <Link className="font-bold text-blue-800 hover:text-blue-500" to="/auth">click here to login here</Link>}</h2>
